...
<head>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>@lang('main.online_shop'): Блог</title>
...
<div class="starter-template">
    <div class="container">
            ...
            @endif
                ...
                @admin
                <a class="btn btn-success col-8 col-lg-2  col-md-4  float-left" type="button" href="{{ route('posts.create') }}">Новый пост</a>
                @endadmin
                ...
                @foreach($posts as $post)
                    <div style="margin-top: 20px" id="main">
                        <div class="post text-left">
                            ...
                            <hr>
                            <p>
                                <i style="font-family: 'Dancing Script', cursive; ">{{$post->description}}</i>
                            </p>
                            <br>
                            ...
                            <div class="btn-group" role="group">
                                <form action="{{ route('posts.destroy', $post) }}" method="POST">
                                    <a class="btn btn-success" type="button"
                                       href="{{ route('posts.show', $post) }}">Читать</a>
                                    @admin
